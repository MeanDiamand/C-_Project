...
public:
	...
	//print method to print the data of the attribute in Marriage class
	std::ostream& print_event(std::ostream& os) const;

	//input method to input the data into the attribute of Marriage class
